...
export function About() {
  ...
  return (
    ...
    >
      <div className="mx-auto flex flex-col lg:flex-row max-w-6xl items-center gap-8 rounded-4xl bg-background dark:bg-primary/30 px-4 py-8 shadow-[0_0_25px_5px_rgba(217,169,77,0.45)] shadow-primary/30 backdrop-blur-2xl sm:gap-10 sm:px-8 sm:py-12  md:gap-16 border border-primary">
